...
It was a 36 hours Capture The Flag event organized by [Cyber Sentinel UPES](https://cybersentinel.in/), which involved various categories of challenges like Cryptography, Web, Steganography, OSINT, Reverse Engineering, Misc, etc.
...
## OSINT:gitcom
```
We are given the username Vibhu025, opened github profile for the username Vibhu025
